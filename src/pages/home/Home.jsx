...
const Home = () => {
  ...
  return (
    <div className="">
      <Navbar />
      <div className="md:mt-[65px] mt-[80px]">
        <Carousel
          swipeable={true}
          draggable={true}
          rtl={true}
        ...
        <div className="mr-3 ">
          ...
          <div className="mr-3 ">
            <img className=" w-full lg:h-[800px]" src={picv2} alt="/" />
          </div>
          <div className="mr-3 ">
            <img className=" w-full  lg:h-[800px]" src={picv3} alt="/" />
          </div>
        </Carousel>
      </div>
      <div className="flex justify-center max-w-screen-xl  px-8 lg:px-14  pb-8 mx-auto ">
        <div>
          ...
          <div className="md:grid hidden md:grid-cols-12 gap-12">
            <div className="col-span-4 ">
              ...
              <div className="flex mt-2 justify-center">
                <i className="text-[20px] font-[600]">Ven Olalekan Popoola</i>
              </div>
            ...
            <div className="col-span-8">
              <div className="flex flex-col gap">
                ...
                <div className="grid grid-cols-12 gap-4 py-7">
                  ...
                  <div className="col-span-6 pt-3">
                    <h5 className="text-sm">
                      Vigil Holds last Friday of every month
                    </h5>
                  </div>
                  <div className="col-span-3 pt-3">
                ...
                <i className="py-2">
                  Prophetic Entrance into the New Month First 3 Days of the
                  Month @ 6.00pm
                </i>
                <h4>
                  Visit.
                  <a
                    className="text-blue-700 pb-2"
                    target="_blank"
                    href="https://www.conacparkview.com/"
                  >
                    {" "}
                    www.Conacparkview.com
                  </a>
                  , Facebook, Instagram & You Tube channels @conacparkview
                </h4>

                <h3 className="text-[14px] pt-2 font-normal">
                  On behalf of our Diocesan, I am so delighted to invite you to
                  a life-changing encounter with the Holy Spirit as we worship
                  God together. By the grace of God, your prayer points will
                  become praise points in Jesus Name. Amen. Shalom.
                </h3>

                <h3 className="text-[14px] pt-2 font-[600]">
                  The Venerable Olalekan Popoola
                </h3>
          ...
          <div className="block md:hidden ">
            ...
            <div className="pt-4">
              <div className="flex flex-col gap">
                <h4 className="font-[600] text-center text-[25px] md:text-[35px] ">
                  You are Welcome
                </h4>
      ...
      <section className="bg-[#327397] py-16">
        <div className="flex justify-center max-w-screen-xl  px-8 lg:px-14  pb-8 mx-auto ">
          <div className="grid md:grid-cols-2 gap-10">
            <div className="">
              <h4 className="text-white text-[20px] font-[500] text-center ">
                UPCOMING EVENTS
              </h4>
              <h4 className="text-white text-[14px] font-[400] text-center pt-3 pb-5">
                Join us in these events at Church of the Natitvity
              </h4>
              <div className=" flex justify-center ">
                {/* <iframe className="w-[70vw] md:w-[40vw] h-full aspect-video " src=""></iframe> */}
                <iframe
                  className="w-[70vw] md:w-[40vw] h-full aspect-video "
                  src="https://www.facebook.com/plugins/video.php?height=314&href=https%3A%2F%2Fweb.facebook.com%2FConacparkview%2Fvideos%2F2738560242988339%2F&show_text=false&width=560&t=0"
                  frameborder="0"
            ...
            <div className="">
              ...
              <h4 className="text-white text-[14px] font-[400] text-center pt-3 pb-5">
                Join all events and services LIVE on youtube
              </h4>
              <div className="flex justify-center">
                <iframe
                  className="w-[70vw] md:w-[40vw] h-full aspect-video "
                  src="https://www.youtube.com/embed/aJOWw1xEqKc?si=nmQdUXWP0sTezupy"
      ...
      <section className="bg-white">
        <div className="flex justify-center max-w-screen-xl  px-8 lg:px-14  pb-8 mx-auto">
          <div className="">
            ...
            <h3 className="text-[20px] font-[400] text-center pb-7">
              “MY YEAR OF FULL RESTORATION (JOEL 2:25-26)”
            </h3>
            <div className="flex justify-center text-center">
              <h4 className="text-[14px] font-normal max-w-[800px] ">
                ...
                never be put to shame.” - <b>Joel 2:25-26 NKJV</b>
              </h4>
            </div>

            <h3 className="text-[20px] pt-10 font-[400] text-center pb-7">
              VESTRY INVOCATION
            </h3>
            <div className="flex justify-center text-center">
              <h4 className="text-[14px] font-normal max-w-[800px] ">
                We worship at thy holy feet and love to serve thee still, take
                thou our hearts, <br />
                our lips, our lives and mould them by thy will
              </h4>
            </div>
          </div>
        </div>
