...
import rev from "../../assets/IMG-20210320-WA0070-removebg-preview-removebg-preview.png";
  ...
  return (
    <div className="">
      ...
      <div className="flex justify-center max-w-screen-xl  px-8 lg:px-14  pb-8 mx-auto ">
        <div>
          <h4 className="text-[#801515] text-center py-10 md:py-20 text-[20px] md:text-[30px] font-[700]">
            WELCOME TO CHURCH OF THE NATIVITY, CONACKPARKVIEW
          </h4>
